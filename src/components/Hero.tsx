...
const Hero = () => {
  return (
    <section className="relative bg-gradient-to-br from-[#F6F9FF] via-[#F5F8FF] to-[#EAF1FF] pt-28 pb-24 px-6 lg:px-12 overflow-hidden">
      <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-16 items-center">
        ...
        <div className="space-y-10">
          ...
          <div className="space-y-5">
            ...
            <h1 className="text-[3rem] lg:text-[4rem] font-bold leading-tight tracking-tight text-[#0E1635]">
              The Ultimate <br />
              Tailor-Made <br />
              eLearning Platform
            </h1>
        ...
        <div className="relative">
          ...
          <div className="relative rounded-2xl overflow-hidden shadow-xl">
            ...
            {/* Floating Host Card */}
            <div className="absolute top-5 right-5 bg-white/90 backdrop-blur-md rounded-xl px-4 py-3 shadow-md border border-gray-100">
            ...
            {[
              {
                ...
                icon: <MessageSquare className="w-5 h-5 text-[#5A74FA]" />,
              },
              {
                title: "Read",
                desc: "Explore reading courses.",
                icon: <BookOpen className="w-5 h-5 text-[#5A74FA]" />,
              },
              {
                title: "Write",
                desc: "Explore writing courses.",
                icon: <PenTool className="w-5 h-5 text-[#5A74FA]" />,
              },
            ].map((item) => (
              <div
                key={item.title}
              ...
              >
                <div className="flex flex-col gap-3">
                  ...
                  <h3 className="font-semibold text-[#0E1635]">{item.title}</h3>
